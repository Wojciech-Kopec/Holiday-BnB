...
import com.kopec.wojciech.engineers_thesis.rest.AccommodationRestController;
import com.kopec.wojciech.engineers_thesis.rest.AccommodationRestControllerTests;
...
public class AccommodationResourceIT extends AbstractRestIT {
    ...
    private static final String baseEndpoint = AccommodationRestController.class.getAnnotation(RequestMapping.class).value()[0];
