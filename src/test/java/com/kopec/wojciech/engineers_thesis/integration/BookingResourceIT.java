...
import com.kopec.wojciech.engineers_thesis.rest.BookingRestController;
...
public class BookingResourceIT extends AbstractRestIT {
    ...
    private static final String baseEndpoint = BookingRestController.class.getAnnotation(RequestMapping.class).value()[0];
