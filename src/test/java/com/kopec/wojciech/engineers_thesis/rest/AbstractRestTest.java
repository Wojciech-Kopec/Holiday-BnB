...
abstract public class AbstractRestTest {
    ...
    private MockHttpServletRequestBuilder buildRequest(HttpMethod httpMethod, String content, String urlTemplate) {
        if (content == null) {
    ...
    protected void httpTestTemplate(HttpMethod requestMethod, String requestLocation, Object requestBodyObj, Object
    ...
    protected MockHttpServletResponse performRequest(HttpMethod requestMethod, String requestLocation, Object
