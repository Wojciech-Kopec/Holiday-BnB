...
import com.kopec.wojciech.engineers_thesis.repository.UserRepository;
import com.kopec.wojciech.engineers_thesis.utils.ModelProvider;
...
/*TODO with modifications in Criteria class with Price and Accommodation Types please modify this class accordingly*/
    ...
    public void singularCriteriaTypeTest() {
        ...
        AccommodationCriteria criteria2 = AccommodationCriteria.builder()
                .accommodationTypes(Lists.newArrayList(accommodationEntity.getAccommodationType(),
                        Accommodation.AccommodationType.CABIN, Accommodation.AccommodationType.SUITE)
                )
                .build();
