...
public class UserRestControllerTests extends AbstractRestUnitTests {
    ...
    private String baseEndpoint = UserRestController.class.getAnnotation(RequestMapping.class).value()[0];
